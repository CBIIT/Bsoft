...
int			star_to_project(Bstar2& star, Bproject* project);
int 		project_to_star(Bproject* project, Bstar2& star, int mg_select, int rec_select);
...
int			read_project_star2(Bstring& filename, Bproject* project)
{
	...
	int			err = star_to_project(star, project);
...
@return int				error code (<0 means failure).
**/
int			write_project_star2(const char* filename, Bproject* project, int mg_select, int rec_select)
{
...
@return int				0.
**/
int			mg_star_update_tags(Bstar2& star)
{
...
int			project_get_fom_tags(Bstar2 star, FOMType* fom_tag)
{
	int				f, n(0);
	Bstring			tag;
